...
void menuSearching(User *u)
{
    ...
    do
    {
        ...
        if (pil == 1)
        {
            ...
            if (hasil == -1)
            {
                cout << "Pemesanan dengan No. " << noTarget << " tidak ditemukan.\n";
            }
            else
            {
        ...
        else if (pil == 2)
        {
            ...
            garis(105, '-');
            if (ditemukan == 0)
                cout << "Tidak ada pelanggan dengan nama yang mengandung \"" << keyword << "\".\n";
            else
